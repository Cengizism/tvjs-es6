...
<document>
  <listTemplate>
    <banner>
      <background>
        <img src="${this.TVBaseURL}resources/images/italy/italy_10_wide.jpg" width="1920" height="360" />
      </background>
    </banner>
    <list>
      <header>
      ...
      <relatedContent>
        <lockup>
          <img src="${this.TVBaseURL}resources/images/italy/italy_5.jpg" width="857" height="482" />
      ...
      <section>
        ...
        <listItemLockup>
          ...
          <relatedContent>
            <lockup>
              <img src="${this.TVBaseURL}resources/images/italy/italy_1.jpg" width="857" height="482" />
        ...
        <listItemLockup>
          ...
          <relatedContent>
            <lockup>
              <img src="${this.TVBaseURL}resources/images/italy/italy_2.jpg" width="857" height="482" />
        ...
        <listItemLockup>
          ...
          <relatedContent>
            <lockup>
              <img src="${this.TVBaseURL}resources/images/italy/italy_3.jpg" width="857" height="482" />
        ...
        <listItemLockup>
          ...
          <relatedContent>
            <lockup>
              <img src="${this.TVBaseURL}resources/images/italy/italy_4.jpg" width="857" height="482" />
