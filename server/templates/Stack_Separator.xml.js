  ...
  <stackTemplate>
    <collectionList>
      ...
      <shelf>
        <section>
          <lockup>
            <img class="roundedImageCorners" src="${this.TVBaseURL}resources/images/italy/italy_1.jpg" width="548" height="269" />
            <title class="showTextOnHighlight">Title 1</title>
          </lockup>
          <lockup>
            <img class="roundedImageCorners" src="${this.TVBaseURL}resources/images/italy/italy_2.jpg" width="548" height="269" />
            <title class="showTextOnHighlight">Title 2</title>
          </lockup>
          <lockup>
            <img class="roundedImageCorners" src="${this.TVBaseURL}resources/images/italy/italy_3.jpg" width="548" height="269" />
            <title class="showTextOnHighlight">Title 3</title>
          </lockup>
          <lockup>
            <img class="roundedImageCorners" src="${this.TVBaseURL}resources/images/italy/italy_4.jpg" width="548" height="269" />
            <title class="showTextOnHighlight">Title 4</title>
          </lockup>
          <lockup>
            <img class="roundedImageCorners" src="${this.TVBaseURL}resources/images/italy/italy_5.jpg" width="548" height="269" />
            <title class="showTextOnHighlight">Title 5</title>
          </lockup>
        </section>
      </shelf>
      <shelf>
        ...
        <section>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_11_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 1</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_12_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 2</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_13_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 3</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_14_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 4</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_15_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 5</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_16_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 6</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_17_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 7</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_18_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 8</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_19_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 9</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/italy/italy_20_poster.jpg" width="250" height="375" />
            <title class="showTextOnHighlight">Title 10</title>
          </lockup>
        </section>
      </shelf>
