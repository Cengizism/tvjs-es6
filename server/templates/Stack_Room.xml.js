  ...
  <stackTemplate class="darkBackgroundColor" theme="dark">
    ...
    <collectionList>
      ...
      <shelf>
        ...
        <section>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/movies/movie_1.lcr" width="250" height="375" />
            <title class="showTextOnHighlight">Title 1</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/movies/movie_2.lcr" width="250" height="375" />
            <title class="showTextOnHighlight">Title 2</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/movies/movie_3.lcr" width="250" height="375" />
            <title class="showTextOnHighlight">Title 3</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/movies/movie_4.lcr" width="250" height="375" />
            <title class="showTextOnHighlight">Title 4</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/movies/movie_5.lcr" width="250" height="375" />
            <title class="showTextOnHighlight">Title 5</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/movies/movie_6.lcr" width="250" height="375" />
            <title class="showTextOnHighlight">Title 6</title>
          </lockup>
          <lockup>
            <img src="${this.TVBaseURL}resources/images/movies/movie_7.lcr" width="250" height="375" />
            <title class="showTextOnHighlight">Title 7</title>
          </lockup>
        </section>
      </shelf>
